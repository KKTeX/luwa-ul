...
\begin{lstlisting}
  ...
  \ProvidesPackage{luwa-ul}[2025/11/25, Version 1.2.0]
  ...
  \NewDocumentCommand{\dashKK}{ O{} +m }{%
    ...
    \expandafter\newunderlinetype\csname beginUnderDash\number\underdash@id\endcsname{%
      \xleaders\hbox{%
        \begin{tikzpicture}[x=0.8ex,y=.2ex,baseline=.7ex]%
          \draw[\underdashgth@color,line width=\underdash@width,xshift=.25ex,yshift=\underdash@bottom+\sladj@tenKK@dashKK] (0,0) -- (\underdash@length,0);%
    ...
    \expandafter\newunderlinetype\csname beginUnderDashtate\number\underdash@id\endcsname{%
      \xleaders\hbox{%
        \begin{tikzpicture}[x=0.8ex,y=.2ex,baseline=.7ex]%
          \begin{scope}[yshift=\f@size/1.1 pt]%
            \draw[\underdashgth@color,line width=\underdash@width,xshift=.1ex,yshift=\underdash@bottom] (0,0) -- (\underdash@length,0);%
  ...
  \NewDocumentCommand{\overLineKK}{ O{} +m }{%
    ...
    \setkeys{overLine}{#1}%
    \underLineKK[bottom=\overLineKK@KK@Adjust-.05em,color=\overLineKK@color]{#2}%
    }
