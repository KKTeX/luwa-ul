...
\begin{OutPut}{Output}
  ...
  \nijyusen[color=red]{あああああああああ}
  \keshinijyusen{あああああ\ruby{あああ}あああ}
...
\begin{SourceCode}{TeX}
  ...
  \parbox<t>[c][6cm][c]{3cm}{%
    \tenKKAuto{あああああ\ruby{あ}{あ}ああ}
    \tenKK[radius=.05ex, distance=.3ex]{あああああああああ}
    \dashKKAuto{あああああ\ruby{あ}{あ}ああ}
    \dashKK[length=.01ex, distance=.1ex]{あああああああああ}
  }
\end{SourceCode}
...
\begin{lstlisting}
  ...
  \ProvidesPackage{luwa-ul}[2025/11/10, Version 1.1.1]
  ...
  \NewDocumentCommand{\tenKK}{ O{} +m }{%
    ...
    \begin{tikzpicture}[x=0.8ex,y=.2ex,baseline=.7ex]%
      \fill[mygray@luwa-ul,yshift=\stength@bottom+\sladj@tenKK@dashKK] (0.3,0) circle (\stength@radius);
  ...
  \NewDocumentCommand{\dashKK}{ O{} +m }{%
    ...
    \expandafter\newunderlinetype\csname beginUnderDash\number\underdash@id\endcsname{%
      \xleaders\hbox{%
        \begin{tikzpicture}[x=0.8ex,y=.2ex,baseline=.7ex]%
          \draw[black,line width=\underdash@width,xshift=.25ex,yshift=\underdash@bottom+\sladj@tenKK@dashKK] (0,0) -- (\underdash@length,0);%
